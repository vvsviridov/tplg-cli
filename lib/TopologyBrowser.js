...
class TopologyBrowser {
  constructor(username, password, url) {
    ...
    this.alarmUrl =  `${url}/alarmcontroldisplayservice/alarmMonitoring/alarmoperations/`
  ...
  async login(){
    const response = await requestWrapper(async () => await this.conn.post(this.loginUrl), 'Login in...')
